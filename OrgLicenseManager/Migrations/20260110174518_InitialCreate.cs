        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Licenses_Users_AssignedToUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedLicenseId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationMemberships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganizationMemberships_Licenses_AssignedLicenseId",
                        column: x => x.AssignedLicenseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Licenses_AssignedToUserId",
                table: "Licenses",
                column: "AssignedToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Licenses_OrganizationId_AssignedToUserId",
                table: "Licenses",
                columns: new[] { "OrganizationId", "AssignedToUserId" });

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMemberships_AssignedLicenseId",
